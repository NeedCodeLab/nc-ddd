...
export class EmployeeInfoVO extends VO<typeof EmployeeInfoVOSchema> {
  ...
  public static create = (val: v.InferInput<typeof EmployeeInfoVOSchema>, key = "info") => {
    return voEffectFactory(val, EmployeeInfoVOSchema, (props) => new EmployeeInfoVO(props), key);
  };
}
